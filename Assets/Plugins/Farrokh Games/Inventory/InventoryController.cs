...
namespace FarrokhGames.Inventory
{
    ...
    public class InventoryController : MonoBehaviour,
        ...
        IEndDragHandler, IPointerExitHandler, IPointerEnterHandler
        {
            ...
            public bool showDraggedItemName;
            public bool equipSingleItemOnly;
            ...
            public void OnPointerDown(PointerEventData eventData)
            {
                if (_draggedItem == null)
                {
                    ...
                    // Output name of selected item
                    if(showDraggedItemName && _itemToDrag != null)
                    {
                        textMesh.text = _itemToDrag.Name.Replace("(Clone)", "").Trim();
                    }
                }
            }
